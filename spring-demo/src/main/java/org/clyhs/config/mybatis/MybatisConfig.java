package org.clyhs.config.mybatis;
...
import org.clyhs.config.db.JdbcConnectionSettings;
 ...
 */
@Configuration
@MapperScan(basePackages = "org.clyhs.module.**.mapper")
public class MybatisConfig {

	private static Logger log = LoggerFactory.getLogger(MybatisConfig.class);
	/**映射文件包*/
	private static final String SQLMAP_PACKAGE = "org.clyhs.module.**.sqlmap";
	/**类转换包*/
